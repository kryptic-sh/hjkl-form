# Contributing to `hjkl-form`

Thanks for considering a contribution. `hjkl-form` is pre-1.0 and the public API
...
```bash
git clone git@github.com:kryptic-sh/hjkl-form.git
cd hjkl-form
